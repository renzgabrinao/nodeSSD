...
export const GPTChatApp= () => {
  const fithProject = dataportfolio[4];
  ...
  */
  ...
  return (
    <HelmetProvider>
      <Container className="GPTChatApp-header">
        <Helmet>
          <meta charSet="utf-8" />
          <title> GPT CLone Chat App | {meta.title} </title>{" "}
          <meta name="description" content={meta.description} />
        </Helmet>
        {/* Main Header section */}
        <Row className="mb-5 mt-3 pt-md-3 justify-content-center">
            <Col lg="8">
                <h1 className="display-4 mb-4"> GPT Clone Chat App </h1>{" "}
      ...
      <Carousel interval={2000} pauseOnHover={false}>
        <Carousel.Item>
          <img src={fithProject.img} alt="FoodScape" style={imageStyles} />
        </Carousel.Item>
        <Carousel.Item>
